...
//        NetworkConverterConfigGroup config = NetworkConverterConfigGroup.createDefaultConfig();
        ...
        NetworkConverterConfigGroup config = new NetworkConverterConfigGroup("osm", "EPSG:4326", Utils.outputCrs, Utils.aldiNetworkInput,
                true, true,
        ...
        LinkAttrParamSet linkAttrParamSet = new LinkAttrParamSet("max_speed", "capacity", "lanes", "width", "length",
                Set.of("surface", "lit", "highway"), Map.of("MAX_SPEED_FIELD", "m/s", "WIDTH_FIELD", "m", "LENGTH_FIELD", "m"));
